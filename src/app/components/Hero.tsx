...
import { ArrowRight, Github, Linkedin, FileText } from "lucide-react"; // npm i lucide-react
...
export default function Hero() {
  return (
    <section className="relative flex min-h-[90vh] flex-col justify-center overflow-hidden px-4 py-24 pt-32 md:px-6">
      ...
      <div className="pointer-events-none absolute -top-40 -right-40 h-96 w-96 rounded-full bg-indigo-500/20 blur-[100px]" />
      <div className="pointer-events-none absolute bottom-0 left-0 h-64 w-64 rounded-full bg-purple-500/10 blur-[80px]" />
      ...
      <div className="mx-auto max-w-5xl text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-zinc-800 bg-zinc-900/50 px-3 py-1 text-sm text-zinc-400 backdrop-blur-md">
            ...
            <span>Available for MERN Stack Roles</span>
          </div>
        </motion.div>
        ...
        >
          I am a Full Stack Engineer specializing in the <span className="text-zinc-200 font-medium">MERN ecosystem</span>. 
          I transform complex requirements into high-performance, secure web applications.
        </motion.p>
