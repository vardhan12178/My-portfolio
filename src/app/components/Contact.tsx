      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-zinc-400">
            I am currently looking for <span className="text-white font-medium">MERN Stack</span> roles.
            If you have an open position or a project in mind, I'd love to chat!
          </p>
        </motion.div>
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          >
            {/* Email Card */}
            <div className="group rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 transition-colors hover:border-emerald-500/50 hover:bg-zinc-900">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  <div className="rounded-lg bg-zinc-800 p-3 text-emerald-400 group-hover:bg-emerald-500/20 group-hover:text-emerald-300 transition-colors">
                    <Mail size={24} />
                  </div>
                  <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group flex flex-col items-center justify-center gap-3 rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 transition-all hover:-translate-y-1 hover:border-emerald-500/30 hover:bg-zinc-900"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid gap-6 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-zinc-800 bg-zinc-950 px-4 py-3 text-white placeholder-zinc-600 outline-none transition focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-xl border border-zinc-800 bg-zinc-950 px-4 py-3 text-white placeholder-zinc-600 outline-none transition focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
                />
              </div>
              ...
              <button
                ...
                className="group flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 px-6 py-4 font-bold text-white transition-all hover:bg-emerald-700 hover:shadow-lg hover:shadow-emerald-500/20 disabled:cursor-not-allowed disabled:opacity-70"
              >
                {isSubmitting ? (
      ...
      <AnimatePresence>
        {showScrollToTop && (
          <motion.button
            ...
            className="fixed bottom-8 right-8 z-50 rounded-full bg-emerald-600 p-3 text-white shadow-xl transition-all hover:bg-emerald-700 hover:-translate-y-1"
